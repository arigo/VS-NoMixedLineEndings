...
namespace VS2022_NoMixedLineEndings
{
    /// <summary>
    ...
    public sealed class NoMixedLineEndingsPackage : AsyncPackage
    {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            //Log("step 5");
            var plugin = new FormatDocumentOnBeforeSave(this);
    ...
    internal class FormatDocumentOnBeforeSave : IVsRunningDocTableEvents3
    {
        readonly NoMixedLineEndingsPackage pkg;

        public FormatDocumentOnBeforeSave(NoMixedLineEndingsPackage pkg)
        {
            this.pkg = pkg;
        }
        ...
        Document FindDocument(DTE _dte, uint docCookie)
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var runningDocumentTable = new RunningDocumentTable(pkg);
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var _dte = Package.GetGlobalService(typeof(DTE)) as DTE;
            var document = FindDocument(_dte, docCookie);
            ...
            var _txtMngr = pkg.GetService<SVsTextManager, IVsTextManager>();
